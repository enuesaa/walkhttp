...
func (ec *executionContext) unmarshalNBrowserInvocationInput2githubᚗcomᚋenuesaaᚋwalkhttpᚋinternalᚋroutegqlᚋschemaᚐBrowserInvocationInput(ctx context.Context, v interface{}) (schema.BrowserInvocationInput, error) {
...
func (ec *executionContext) unmarshalNServerInvocationInput2githubᚗcomᚋenuesaaᚋwalkhttpᚋinternalᚋroutegqlᚋschemaᚐServerInvocationInput(ctx context.Context, v interface{}) (schema.ServerInvocationInput, error) {
...
func (ec *executionContext) unmarshalOHeaderInput2ᚕᚖgithubᚗcomᚋenuesaaᚋwalkhttpᚋinternalᚋroutegqlᚋschemaᚐHeaderInput(ctx context.Context, v interface{}) ([]*schema.HeaderInput, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
...
func (ec *executionContext) unmarshalOHeaderInput2ᚖgithubᚗcomᚋenuesaaᚋwalkhttpᚋinternalᚋroutegqlᚋschemaᚐHeaderInput(ctx context.Context, v interface{}) (*schema.HeaderInput, error) {
	if v == nil {
		return nil, nil
	}
