  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger>
        ...
        <button className='flex cursor-pointer py-1 w-full text-grayer text-center hover:bg-gray'>
      ...
      <Dialog.Content maxWidth='700px' aria-describedby={undefined} className='relative px-8 py-2'>
